...
class PageTiktok(BaseCase): #inherit BaseCase
    ...
    def get_hashtag_list(self, scenario_num):
        if scenario_num == 1: #amy hu
            return ['minecraft', 'gaming', 'gamer', "ps", 'playstation', 'videogames', 'game', 'xbox', 'games', 'twitch', 'fortnite', 'pc', 'memes', 'pcgaming', 'gamers', 'gamingcommunity', 'youtube', 'xboxone', 'gamergirl', 'nintendo', 'gta', 'callofduty', 'streamer', 'pubg', 'videogame', 'esports', 'bhfyp', 'meme', 'twitchstreamer', 'fortnitefunny', 'fortnitechapter5', 'gamingontiktok', 'gamelancer', 'pcgamer', 'pcgamer', 'diabloiv', 'gamingontiktok', 'epicgames', 'leaguetok', 'gamingmemes', 'minecraftclips', 'videogames', 'rocketleague', 'valorant', 'genshinimpact', 'warzone', 'gta5', 'roblox']
        elif scenario_num == 2: #rachel xu
            return ["kpop", "dance", "dancechallenge", "jenniesolo", "publicdance", "DanceTrends", "DanceTutorial", "DanceFitness", "KpopDance", "KpopChallenge", "KpopCover", "KpopMoves", "KpopChoreo", "KpopIdol", "KpopDanceTutorial", "KpopFancam", "KpopChoreography", "BTS", "EXO", "BLACKPINK", "blackpink", "TWICE", "RedVelvet", "NCT", "MAMAMOO", "ITZY", "SEVENTEEN","EVERGLOW", "BIGBANG", "SHINee"]
        elif scenario_num == 3: #lillie godinez
            return ["Foodlover", "foodie", "foodtiktok", "cooking", "eating", "yummy", "delicious", "mukbang", "eat", "recipe", "tiktokfood", 'cooking', 'baking', 'garlic', 'steak','castiron', 'stainlesssteel', 'foodtiktok', 'food', 'foodvideo', 'foodie', 'chicken','recipe', 'easyrecipe', 'easyrecipes', 'asmrfood', 'italianfood', 'mexicanfood', 'asianfood', 'ramen', 'noodles', 'dinner', 'lunch', 'breakfast', 'dinnerideas', 'homecooking', 'comfortfood', 'recipesoftiktok', 'potato', 'pasta', 'chef', 'tastetest']
        elif scenario_num == 4: #sooahn lee
            return ["makeuptutorial", "makeup", "beauty", "makeupartist", "makeuphacks", "tutorial", "eyeliner", "makeuptransformation", "grwn", "mua", "skincare", "makeuproutine", "makeupchallenge", "makeup", "beauty", "launch", "newproduct", "grwm", "blush", "foundation", "sephora", "ultabeauty", "skincare", "hairstyle", "hairproducts", "concealer", "brushes", "lipstick", "bronzer", "contour", "mascara", "unboxing", "hair", "highlighter", "makeuptutorial", "lipgloss", "dyson", "gitter", "cosmetics", "makeupaddict", "beautyhacks", "beautycommunity", "makeupoftheday", "hairtutorial", "hairgoals"]
        elif scenario_num == 5: #adelle wang
            return ['sports', 'sport', 'baseball', 'basketball', 'football', 'mlb', 'nba', 'nfl', 'nhl', 'hockey', 'olympics', 'gymnastics', 'track', 'trackandfield', 'superbowl', 'fitness', 'training', 'gym', 'workout', 'motivation', 'athlete', 'exercise', 'boxing', 'mma', 'nike', 'team', 'sportswear', 'sportsnews', 'sportscenter', 'sportsbetting', 'fifa', 'soccer']
        elif scenario_num == 6: #brooke bao
            return ["Dance", "dancer", "music", "dancechallenge", "dancetutorial", "dancers", "lyric", "song", "spotify", "applemusic","art", "painting", "mural", "drawing", "artist", "digitalart", "sketchbook", "sketching", "pinterest", "illustration", "artjournal", "acrylic", "stilllife", "colorpencils", "animation", "artreel", "sketchingdaily", "artdaily", "artistic", "artwork", "artoftheday", "gouache", "oilpainting", "artgallery", "procreate", "prints", "ballpointpen", "mixedmedia"]
        else: 
            return []
